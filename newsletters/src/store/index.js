  ...
  state: {
    templates: [
      ...
      },
      {
        ...
        html: '<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td><img src="https://placehold.co/100x50" alt="Company Logo"></td></tr><tr><td><table  width="100%" cellpadding="10px" cellspacing="0" border="0" bgcolor="#ffffff" align="center"><tr><td align="center"> <img style="width:50%;" ref="image_1" id="{{id_image_1}}" src="{{image_1}}" alt="Company Logo"></td></tr><tr><td align="center" width="50%">  <p>{{p_1}}</p> </td></tr><tr><td align="center"> <a href="">{{link_1}}</a> </td></tr></table></td></tr><tr><td><table width="100%" cellpadding="0" cellspacing="50px" border="0" bgcolor="#e3e7ee" align="center"><tr><td align="center" width="50%"><img style="width:80%;" src="{{image_2}}" alt="Company Logo"></td><td align="left" width="50%"> <p>{{p_2}}</p> <a href="">{{link_2}}</a></td></tr></table></td></tr><tr><td><table width="100%" cellpadding="0" cellspacing="50px" border="0" bgcolor="#fff" align="center"><tr><td align="left" width="50%"> <p>{{p_3}}</p> <a href="">{{link_3}}</a></td><td align="center" width="50%"><img style="width:80%;" src="{{image_3}}" alt="Company Logo"></td></tr></table></td></tr><tr><td><table width="100%" cellpadding="0" cellspacing="50px" border="0" bgcolor="#007BFF" align="center"><tr><td align="center"><a href=""> <img style="width:30px;" src="{{image_4}}" alt="Company Logo"></a><a href=""> <img style="width:30px;" src="{{image_5}}" alt="Company Logo"></a><a href=""> <img style="width:30px;" src="{{image_6}}" alt="Company Logo"></a><a href=""> <img style="width:30px;" src="{{image_7}}" alt="Company Logo"></a></td></tr></table></td></tr></table></td></tr></table>',
      },
    ],
  },
  getters: {},
